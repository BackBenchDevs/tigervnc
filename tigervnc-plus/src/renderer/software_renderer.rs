use super::types::{CursorData, FrameBuffer, RenderBackend};
...
impl RenderBackend for SoftwareRenderer {
    ...
    fn render_to_egui(&mut self, ui: &mut Ui, available_size: Vec2) -> Option<egui::Response> {
        if self.dirty {
        ...
        let scale_x = available_size.x / fb_w as f32;
        let scale_y = available_size.y / fb_h as f32;
